...
import React, { SyntheticEvent, ElementType, PureComponent, ComponentProps, GetDerivedStateFromProps, ReactNode, CSSProperties } from 'react';
...
declare const Gif$1: {
    ({ gif, gif: { bottle_data: bottleData }, width, percentWidth, height: forcedHeight, onGifRightClick, className, onGifClick, onGifKeyPress, onGifSeen, onGifVisible, user, backgroundColor, overlay, hideAttribution, noLink, borderRadius, style, tabIndex, }: Props$6): React.JSX.Element | null;
    className: string;
    imgClassName: string;
